...
MYSQL_CONTAINER_NAME=flint-server-test-mysql
MYSQL_ROOT_PASSWORD=flint-server-test
MYSQL_DATABASE=flint_server
MYSQL_EXPORT_PORT=7519

REDIS_CONTAINER_NAME=flint-server-test-redis
REDIS_PASSWORD=flint-server-test
